...
namespace Project_1.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(Project_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string title, int semesster, string programme)
        {
            ...
            var courseTitleVM = new CourseSearchViewModel
            {
        ...
        {
            IList<Course> courses = _context.Course.ToList();
            IList<Teacher> teachers = _context.Teacher.ToList();
            IList<Student> students = _context.Student.ToList();
